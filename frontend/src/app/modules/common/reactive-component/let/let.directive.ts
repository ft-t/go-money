 ...
 * - it takes away the multiple usages of the `ngrxPush` or `ngrxPush` pipe
 * - a unified/structured way of handling null and undefined
 * - triggers change-detection differently if `zone.js` is present
 * or not (`ChangeDetectorRef.detectChanges` or `ChangeDetectorRef.markForCheck`)
