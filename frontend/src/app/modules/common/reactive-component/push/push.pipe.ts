 ...
 * @description
 *
 * The `ngrxPush` pipe serves as a drop-in replacement for the `ngrxPush` pipe.
 ...
 * ```
 *
 * The problem is `ngrxPush` pipe just marks the component and all its ancestors as dirty.
 ...
 * lean to bad performance or even unusable applications, but the `ngrxPush` pipe does not work in zone-less mode.
 *
