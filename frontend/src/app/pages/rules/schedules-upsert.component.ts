...
@Component({
    ...
    imports: [InputNumberModule, TextareaModule, Fluid, InputText, ReactiveFormsModule, FormsModule, Button, Toast, ColorPickerModule, Checkbox, ScriptEditorComponent, Message],
