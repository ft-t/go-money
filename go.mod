...
require (
	buf.build/gen/go/xskydev/go-money-pb/connectrpc/go v1.18.1-20250811233719-d53344468291.1
	buf.build/gen/go/xskydev/go-money-pb/protocolbuffers/go v1.36.7-20250811233719-d53344468291.1
